...
def convert_open(base_path,*,convert_type='simple'):
    ...
    try:
        params['site_to_site_decoherence_gamma'] = simple['site_to_site_decoherence_gamma']
    except KeyError:
        pass
    ...
    try:
        params['optical_decoherence_gamma'] = simple['optical_decoherence_gamma']
    except KeyError:
        pass

    try:
        params['exciton_exciton_dephasing_gamma'] = simple['exciton_exciton_dephasing_gamma']
    except KeyError:
        pass

    try:
        params['exciton_decoherence_gamma'] = simple['exciton_decoherence_gamma']
    except KeyError:
        pass
    ...
    with open(parameter_file_name,'w+') as yamlstream:
        yamlstream.write('### This file was generated by UF2, do not modify unless you know what you are doing \n')
